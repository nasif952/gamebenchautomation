        ...
        # In-game mode (Virtual Xbox 360 Controller via vgamepad)
            ...
            if action == "gamepad_axis":
                ...
                if axis == "ABS_X":
                    ...
                    gamepad.left_joystick_float(x_value_float=0.0, y_value_float=axis_value)  # No inversion
                    ...
                    gamepad.right_joystick_float(x_value_float=0.0, y_value_float=axis_value)  # No inversion
